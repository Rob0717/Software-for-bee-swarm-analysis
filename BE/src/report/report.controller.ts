...
export class ReportController {
  ...
  @ApiNoContentResponse({description: 'Report successfully created.'})
  @ApiBadRequestResponse({
  ...
  @ApiNoContentResponse({description: 'Report successfully taken over.'})
  @ApiNotFoundResponse({
    description: `Messages:
  - { type: 'USER_NOT_FOUND', code: 'USER_NOT_FOUND' }
  - { type: 'REPORT_NOT_FOUND', code: 'REPORT_NOT_FOUND' }`,
  ...
  @ApiNoContentResponse({description: 'Assignment successfully removed.'})
  @ApiNotFoundResponse({
    description: `Messages:
  - { type: 'USER_NOT_FOUND', code: 'USER_NOT_FOUND' }
  - { type: 'REPORT_NOT_FOUND', code: 'REPORT_NOT_FOUND' }`,
